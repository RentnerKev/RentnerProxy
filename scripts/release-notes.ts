...
export function renderReleaseNotes(input: ReleaseNotesDocumentInput): RenderedReleaseNotes {
    ...
    const body = [
        ...
        codeFence,
        '',
        `[Release details and limitations](${repositoryWebUrl(input.repository)}/blob/${encodeURIComponent(input.tagName)}/CHANGELOG.md) · [Upgrade and recovery instructions](${repositoryWebUrl(input.repository)}/blob/${encodeURIComponent(input.tagName)}/README.md#upgrade)`,
        '',
