...
import { getDatabaseConnection } from './client.server'
import type { DatabaseHealthDependencies, DatabaseProbe } from './Types/health.types'
...
function createProbe(): DatabaseProbe | null {
    ...
    const query = connection.client`SELECT 1 AS health`.execute()
