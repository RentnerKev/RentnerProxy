    ...
    return (
        <div className="relative">
            ...
            <Tooltip content={state.toggleLabel} side="left">
                <button
                    type="button"
                    className="absolute top-1/2 right-[0.05rem] inline-grid size-[2.75rem] -translate-y-1/2 cursor-pointer place-items-center rounded-[0.7rem] border-0 bg-transparent p-0 text-muted hover:bg-code hover:text-brand-text focus-visible:outline-2 focus-visible:-outline-offset-3 focus-visible:outline-brand-600"
